...
\usepackage{setspace}
\usepackage[a4paper,inner=4cm,outer=2.5cm,bottom=2cm]{geometry}
...
% appendix (toc,page: adds "Appendices" divider page and TOC entry)
...
% reduce top whitespace on chapter/abstract/contents first pages
\usepackage{titlesec}
\titlespacing*{\chapter}{0pt}{10pt}{0pt}

% line-breaking underline (for abstract title, works with XeTeX)
